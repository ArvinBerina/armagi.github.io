...
<h2 class="text-center">Electronic Devices</h2>
    <hr>
    <div class="container">
      <div class="row text-center">
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            <img class="card-img-top" src="images/w1.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 225</h4>
              <h5 class="card-title">Gaming Headset</h5>
              <p class="card-text">SXixi Headset Headphone Headphones Gaming Headset Stereo Noise Isolation Surround Sound With Mic.</p>
        ...
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            <img class="card-img-top" src="images/w2.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 180</h4>
              <h5 class="card-title">Gaming Mouse</h5>
              <br>
              <p class="card-text">Logitech G102 Lightsync Gaming Mouse Black.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            <img class="card-img-top" src="images/w3.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 399</h4>
              <h5 class="card-title">Gaming Keyboard</h5>
              <p class="card-text">Zeus K003 ( Darth-Vader ) Real RGB Mechanical Gaming Keyboard - Online Exclusive Edition.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row text-center mt-4">
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            <img class="card-img-top" src="images/w6.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 890</h4>
              <h5 class="card-title">Wireless Headset</h5>
              <p class="card-text">MYPRO H3 IPX4 Wireless & Wired Bluetooth Over Ear Powerful Bass Headphones With Mic.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
             <img class="card-img-top" src="images/w4.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 1500</h4>
              <h5 class="card-title">Gaming Chair</h5>
              <br>
              <p class="card-text">Nostin Ergonomics Gaming Chair Adjustable Backrest Reclining Office Racing.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
             <img class="card-img-top" src="images/w5.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 250</h4>
              <h5 class="card-title">Wireless Keybard</h5>
              <p class="card-text">Zeus K-100 ( SteamPunk ) Retro Round Keycaps 104 Keys Keyboard For Gaming And Office.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
