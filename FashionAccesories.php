...
<h2 class="text-center">Fashion Accesories</h2>
    <hr>
    <div class="container">
      <div class="row text-center">
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            <img class="card-img-top" src="images/x16.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 79</h4>
              <h5 class="card-title">Tala Moon Necklace</h5>
              <p class="card-text">Jewelry Star and Moon Necklace Temperament Simple Creative Necklace for Women.</p>
        ...
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            <img class="card-img-top" src="images/x18.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 450</h4>
              <h5 class="card-title">Tala Moon Bracelet</h5>
              <p class="card-text"> Ladies Bracelet Stainless Steel Moon Pendant Gold / Rose Gold / Steel Double-layer Fashion Casual.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            <img class="card-img-top" src="images/x15.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 250</h4>
              <h5 class="card-title">Silver Flower Earing</h5>
              <br>
              <p class="card-text">Silver Flower Ear Studs Women's Elegant Trendy Small Earrings Screw Twist.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row text-center mt-4">
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            <img class="card-img-top" src="images/x14.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 263</h4>
              <h5 class="card-title">Snake Design Silver Ring</h5>
              <br>
              <p class="card-text">TATA Pure 92.5% Italy silver Ladies Snake Design Ring J012.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
             <img class="card-img-top" src="images/x13.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 189</h4>
              <h5 class="card-title">Gold Chain Necklace</h5>
              <br>
              <p class="card-text">LS Jewelry 18K Gold Plated Pendant Necklace for Women 99.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
             <img class="card-img-top" src="images/x17.png" alt="Card image cap">
            <div class="card-body">
			  <h4 class="card-price">Php 290</h4>
              <h5 class="card-title">Men's Lether Belt </h5>
              <p class="card-text">Men Leather Belt for Men Dress Belts with Prong Alloy Pin Buckle Jeans Pants Belt men’s.</p>
              <a href="#" class="btn-grad">Add to Cart</a>
            </div>
          </div>
        </div>
